function [count1, count2, infield] = probevolve2(E,kappa,gamma,g,wc,w0,wl,N,tlist,neigs)
%
% [count1, count2, infield] = probevolve2(E,kappa,gamma,g,wc,w0,wl,N,tlist,neigs)
