echo off
% XPROBQMC2 solves the problem for the two-level atom in the driven cavity 
...
%  using the quantum Monte Carlo algorithm, writing out expectation values
%--------------------------------------------------------------------------
pause % Press [Enter] to view PROBQMC2.M, the function called 
%--------------------------------------------------------------------------
%
type probqmc2
%
%--------------------------------------------------------------------------
pause % Press [Enter] call PROBQMC2 and evaluate 500 trajectories
%--------------------------------------------------------------------------
