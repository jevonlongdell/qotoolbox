function [count1, count2, infield] = probqmc3(E,kappa,gamma,g,wc,w0,wl,N,tlist,ntraj)
%
% [count1, count2, infield] = probqmc3(E,kappa,gamma,g,wc,w0,wl,tlist,ntraj)
...
while itraj < ntraj(1)
   k = k + 1;
   [iter,count1(:,k),count2(:,k),infield(:,k)] = expread(fid,nexpect,tlist);
   itraj = itraj + ntraj(2);
end
fclose(fid);
