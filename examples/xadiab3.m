echo off
% XADIAB3 uses the quantum Monte Carlo algorithm to solve for problem
...
%--------------------------------------------------------------------------
nexpect = mc2file('adiab3i.dat',-i*Heff,{C{1},C{2},C{3},C{4}},{a'*a,(a'*a)^2},psi0,tlist,ntraj);
%--------------------------------------------------------------------------
% Call the equation solver
%--------------------------------------------------------------------------
mcsolve('adiab3i.dat','adiab3o.dat');
%--------------------------------------------------------------------------
pause; % Press [Enter] to read in output file
%--------------------------------------------------------------------------
fid = fopen('adiab3o.dat','rb');
