function de2file3(fid,x0,tlist,seed,ntraj,ftraj,refine)
% PRIVATE/DE2FILE3 writes out the initial conditions, the list of times 
...
if nargin<5, ntraj=1; end
if nargin<6, ftraj=ntraj; end
if nargin<7, refine=1; end
if isa(x0,'qo')
  x0 = x0.data;
end
x0 = full(x0);
fwrite(fid,2003,'integer*4');	% Identification code
