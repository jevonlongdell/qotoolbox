...
*/
    ...
    if (qrgnin)
        goto S10;
    fatal_error("RANLIB/COM: ADVNST called before random generator initialized - ABORT");
S10:
    gscgn(0L, &g);
    ib1 = Xa1;
    ib2 = Xa2;
...
*/
    ...
    if (qrgnin)
        goto S10;
    fatal_error("RANLIB/COM: GETSD called before random number generator  initialized -- abort!");
S10:
    gscgn(0L, &g);
    *iseed1 = *(Xcg1 + g - 1);
    *iseed2 = *(Xcg2 + g - 1);
...
*/
    ...
    if (qrgnin)
        goto S10;
    fatal_error("RANLIB/COM: INITGN called before random number generator  initialized -- abort!");
S10:
    gscgn(0L, &g);
    if (-1 != isdtyp)
        goto S20;
...
*/
    ...
    *(Xlg2 + g - 1) = mltmod(Xa2w, *(Xlg2 + g - 1), Xm2);
    goto S50;
S40:
    fatal_error("RANLIB/COM: isdtyp not in range in INITGN");
S50:
    *(Xcg1 + g - 1) = *(Xlg1 + g - 1);
    *(Xcg2 + g - 1) = *(Xlg2 + g - 1);
#undef numg
...
*/
    ...
    if (qrgnin)
        goto S10;
    fatal_error("RANLIB/COM: SETANT called before random number generator  initialized -- abort!");
S10:
    gscgn(0L, &g);
    Xqanti[g - 1] = qvalue;
#undef numg
...
*/
    ...
    if (qrgnin)
        goto S10;
    fatal_error("RANLIB/COM: SETSD called before random number generator  initialized -- abort!");
S10:
    gscgn(0L, &g);
    *(Xig1 + g - 1) = iseed1;
    *(Xig2 + g - 1) = iseed2;
