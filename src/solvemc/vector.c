...
void    N_VLinearSum(real a, N_Vector x, real b, N_Vector y, N_Vector z)
{
    ...
    /* Cases: (1) a == 1.0, b == other or 0.0, (2) a == other or 0.0, b ==
     * 1.0 */
    ...
    /* Do all cases not handled above: (1) a == other, b == 0.0 - user should
     * have called N_VScale (2) a == 0.0, b == other - user should have
     * called N_VScale (3) a,b == other, a !=b, a != -b */
